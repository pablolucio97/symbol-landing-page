...
import BarsRating from "./index";

type Story = StoryObj<typeof BarsRating>;

const meta: Meta<typeof BarsRating> = {
  title: "Ratings/BarsRating",
  component: BarsRating,
  tags: ["autodocs"],
  parameters: {
    layout: "centered",
...
export const Default: Story = {
  render: (args) => {
    ...
    return <BarsRating {...args} value={value} onChange={setValue} />;
  },
  args: {
    showLabels: true,
